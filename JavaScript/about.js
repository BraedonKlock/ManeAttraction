...
export function aboutDisplay() {
  ...
  p.innerHTML = "Kendra began her hairdressing journey in 2013 at St. Lawrence College in Kingston, where she completed a two-year diploma in hairstyling. Following her formal education, she completed a three-year apprenticeship that combined hands-on salon experience with classroom training. She has been a licensed hairstylist since 2016.<br><br><h2>Continued Learning</h2>Passionate about continued growth, Kendra trained at the Redken Academy in Toronto, where she expanded her knowledge in color theory, advanced cutting techniques, blonding concepts and formulations, freehand balayage painting, and foliage techniques. She is also certified in curly hair through DevaCurl, allowing her to specialize in textured and natural curls.<br><br>In addition to hairstyling, Kendra is currently working toward her makeup certification, further expanding her ability to offer complete, personalized beauty services.<br><br><h2>Commitment</h2>With a deep love for the craft and a commitment to making others feel their best, Kendra brings skill, creativity, and care to every appointment.";
  main.appendChild(p);
  waitForAllImages(() => {
